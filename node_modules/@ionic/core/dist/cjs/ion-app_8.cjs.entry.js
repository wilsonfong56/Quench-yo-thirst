...
const frameworkDelegate = require('./framework-delegate-3714e9a9.js');
const index$2 = require('./index-9f105a7f.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!ionicGlobal.config.getBoolean('_testing')) {
          Promise.resolve().then(function () { return require('./index-7c902b90.js'); }).then((module) => module.startTapClick(ionicGlobal.config));
        }
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-3c0eca18.js'); }).then((module) => module.startStatusTap());
        }
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-1dba3f3f.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
